"""Offline parameter training script for quantum reservoir.

Pre-computes and locks optimal reservoir parameters for 8-qubit and 27-qubit models.
"""
...
from modules.reservoir_trainer import train_reservoir_offline  # noqa: E402 # pylint: disable=wrong-import-position,import-error


def main() -> None:
    """Train and save offline reservoir parameters."""
